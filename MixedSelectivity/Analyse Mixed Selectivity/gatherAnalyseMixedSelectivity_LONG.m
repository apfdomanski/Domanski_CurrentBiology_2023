...
reject_list={'KrzesimirLONG2_Events.mat','MiroslawLONG1_Events.mat','MiroslawLONG2_Events.mat'}; %'ALL_events.mat'
...
for iFile = 1:length(fileListAss)
        ...
        fnIn = sprintf('%s\\MixedSelectivity_LONG\\MixedSelectivity\\%s_MixedSelectivity_Ass.mat',pat,fname);
        load(fnIn ,'D_Ass');

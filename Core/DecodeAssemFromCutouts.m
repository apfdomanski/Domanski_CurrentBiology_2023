...
pat{2} = [pat{1} filesep 'KDE_bins'];                    % location of calculated firing P.rates for Task period
pat{3} = [pat{2} filesep P.expt];                       % location of the processed sleep assembly activations
cd(pat{1})

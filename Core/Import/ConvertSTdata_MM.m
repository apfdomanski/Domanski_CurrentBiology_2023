% Prototype wrapper code for calculating smoothed estimates of firing rate by optimised kernel density smoothing. 
%
...
% load LONG1.mat; ext='L1';
load Jaroslawscopolamine.mat; ext='Jaroslawscopolamine';
%load data/LONG2.mat; ext='L2';

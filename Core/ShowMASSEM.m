function [evtB,Clr]=ShowM_ASSEM(Tmtx,iFR,CL,iFRred,ret,TrCol,sc)
% Plot a heatmap timeseries showing the activation pattern of lots of assemblies
%
...
%     figure(ret+2), hold off cla;
    ...
    xlabel('Time (s)','FontSize',Font_Size); ylabel('Assem #','FontSize',Font_Size);
